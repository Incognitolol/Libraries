...
public class TabListLayout {
    ...
    public void put(int column, int row, String text, MojangSkin skin) {
        this.put(TabListUtils.convertToSlot(row, column), text, skin, 0);
    }
    public void put(int column, int row, String text, MojangSkin skin, int ping) {
        this.put(TabListUtils.convertToSlot(row, column), text, skin, ping);
    }

    public void put(int column, int row, String text) {
        this.put(TabListUtils.convertToSlot(row, column), text, null, 0);
    }
    public void put(int column, int row, String text, int ping) {
        this.put(TabListUtils.convertToSlot(row, column), text, null, ping);
    }

    public void put(int index, String text, MojangSkin skin, int ping) {
